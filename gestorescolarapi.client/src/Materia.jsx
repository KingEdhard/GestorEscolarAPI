...
export default function Materia({ data, onCreate, onUpdate, onDelete }) {
    const [formData, setFormData] = useState({ id: '', nombre: '', semestre: '', profesorId: '' });
    ...
    const handleSubmit = (event) => {
        ...
        setFormData({ id: '', nombre: '', semestre: '', profesorId: '' });
    };
    ...
    return (
        <div className="container mx-auto p-4 mb-8">
            <h2 className="text-2xl font-bold mb-4">Nueva Materia</h2>
            <form
            ...
            <h2 className="text-2xl font-bold mt-4 mb-2">Materias</h2>
                ...
                <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            ...
                            <th scope="col" className="px-6 py-3">ID del Profesor</th>
